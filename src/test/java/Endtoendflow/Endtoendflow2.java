...
public class Endtoendflow2 {
	...
	
	{
		...
		driver.findElement(By.xpath("//input[@id='thumbnail']")).sendKeys("C:\\Users\\Narayana\\Desktop\\Selenium.jpg");
		...
		WebElement text=driver.findElement(By.xpath("//td[contains(.,'testcourse3')]"));
		...
		WebElement DeleteB=driver.findElement(By.xpath("(//button[@class='action-btn delete-btn'])[1]"));
